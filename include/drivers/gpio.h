...
#define GPIO_INPUT              (1 << 8)

/** Enables pin as output, no change to the output state. */
#define GPIO_OUTPUT             (1 << 9)

/** @cond INTERNAL_HIDDEN */

/* Initializes output to a low state. */
#define GPIO_OUTPUT_INIT_LOW    (1 << 10)

/* Initializes output to a high state. */
#define GPIO_OUTPUT_INIT_HIGH   (1 << 11)
 ...
 */
#define GPIO_INT_LEVELS_LOGICAL        (1 << 13)
...
#define GPIO_INT_DEBOUNCE              (1 << 17)

/**
 * @name GPIO drive strength flags
 * The `GPIO_DS_*` flags are used with `gpio_pin_configure` or
 * `gpio_port_configure`, to specify the drive strength configuration of a GPIO
 * pin.
 *
