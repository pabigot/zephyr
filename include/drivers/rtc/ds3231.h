 ...
 */
typedef void (*rtc_ds3231_notify_callback)(struct device *dev,
...
struct rtc_ds3231_alarm {
	 ...
	 * application should use rtc_ds3231_check_alarms() to
 ...
 * changes.
 *
 * @note Unlike rtc_ds3231_stat_update() the return value from this
 ...
 *
 * @note Unlike rtc_ds3231_ctrl_update() the return value from this
 ...
 *
 * Applications should use rtc_ds3231_get_syncpoint() to retrieve the
 ...
 *
 * This is a variant of rtc_ds3231_synchronize() for use from user
 * threads.
 *
 * @param dev the DS3231 device pointer.
 *
 ...
 * @retval -ENOTSUP if the required interrupt is not configured
 */
__syscall int rtc_ds3231_req_syncpoint(struct device *dev,
 ...
 */
__syscall int rtc_ds3231_get_syncpoint(struct device *dev,
