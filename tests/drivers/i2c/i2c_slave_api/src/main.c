...
static void run_full_read(const struct device *i2c, uint8_t addr,
			  uint8_t *comp_buffer)
{
	int ret;
...
static void run_partial_read(const struct device *i2c, uint8_t addr,
			     uint8_t *comp_buffer,
			     unsigned int offset)
{
	int ret;
...
static void run_program_read(const struct device *i2c, uint8_t addr,
			     unsigned int offset)
{
	int ret, i;
